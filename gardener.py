...
def get_gemini_response(input_text):
    try:
        ...
        return response.text if response and hasattr(response, 'text') 
    else:
...
# Streamlit UI
st.set_page_config(page_title='Garden Lover❤️')
...
region = st.text_input("Enter your region",placeholder="Eg.California, India, London")
